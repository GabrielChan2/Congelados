...
<body>
	...
	<div class="container-cards full-box" style="padding-bottom: 40px;">
		...
		<div class="card shadow-1-strong">
			...
			<div class="card-body text-center">
            <a href="Carrito.php" class="btn btn-success btn-sm"><i class="fas fa-shopping-bag fa-fw"></i> &nbsp; Agregar</button>
				&nbsp; &nbsp;
	...
	<nav aria-label="Page navigation example">
			<ul class="pagination justify-content-center">
				<li class="page-item">
					<a class="page-link" href="menu.php">Anterior</a>
				</li>
	
				</li>
				<li class="page-item ">
					<a class="page-link" href="menu.php">1</a>
				</li>
				<li class="page-item active">
					<a class="page-link" href="menu2.php">2</a>
				</li>
				<li class="page-item">
					<a class="page-link" href="menu2.php">Siguiente</a>
				</li>
			</ul>
		</nav>
