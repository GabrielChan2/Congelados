...
<body>
	...
	<div class="container container-web-page">
	    <h3 class="font-weight-bold poppins-regular text-uppercase">Productos del Proveedor</h3>
		...
		<div class="card shadow-1-strong">
			...
			<div class="card-body text-center">
            <a href="Carrito.php" class="btn btn-info btn-sm"><i class="fas fa-utensils fa-fw"></i> &nbsp; Agregar a carrito</a>
				&nbsp; &nbsp;
