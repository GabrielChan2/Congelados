...
<body>
	...
	<div class="container container-web-page">
	    <h3 class="font-weight-bold poppins-regular text-uppercase">Lista de proveedores</h3>
	            ...
	            <div class="col-12 col-sm-4 text-center text-sm-start">
	                <div class="dropdown">
	                    <button class="btn btn-link dropdown-toggle" type="button" id="categorySubMenu" data-mdb-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
	                        <i class="fas fa-hamburger fa-fw"></i> &nbsp; Tiendas
	                    </button>
	                    <div class="dropdown-menu" aria-labelledby="categorySubMenu">
	                        <a class="dropdown-item" href="#">Cremeria Milagros</a>
	                        <a class="dropdown-item" href="#">Tienda Don Jose</a>
	    ...
	    <div class="container-cards full-box" style="padding-bottom: 40px;">
	        ...
	        <div class="card shadow-1-strong">
	            <img class="card-img-top" src="./assets/platillos/mexicana.png" alt="nombre_platillo">
	            <div class="card-body text-center">
	                <h5 class="card-title font-weight-bold">La Mexicana</h5>
	                <p class="card-text lead"><span class="badge bg-secondary"></span></p>
	            </div>
	            <div class="card-body text-center">
	                <button type="button" class="btn btn-success btn-sm"><i class="fas fa-shopping-bag fa-fw"></i> &nbsp; Información</button>
	                &nbsp; &nbsp;
	                <a href="ProductosProveedor.php" class="btn btn-info btn-sm"><i class="fas fa-utensils fa-fw"></i> &nbsp; Productos</a>
	            </div>
	        </div>

	        <div class="card shadow-1-strong">
	            <img class="card-img-top" src="./assets/platillos/carnesfrias.png" alt="nombre_platillo">
	            <div class="card-body text-center">
	                <h5 class="card-title font-weight-bold">Carnes Frias</h5>
	                <p class="card-text lead"><span class="badge bg-secondary"></span></p>
	            </div>
	            <div class="card-body text-center">
	                <button type="button" class="btn btn-success btn-sm"><i class="fas fa-shopping-bag fa-fw"></i> &nbsp; Información</button>
	        ...
	        <div class="card shadow-1-strong">
	            <img class="card-img-top" src="./assets/platillos/latiendita.png" alt="nombre_platillo">
	            <div class="card-body text-center">
	                <h5 class="card-title font-weight-bold">Tiendita 24hrs</h5>
	                <p class="card-text lead"><span class="badge bg-secondary"></span></p>
	            </div>
	            <div class="card-body text-center">
	                <button type="button" class="btn btn-success btn-sm"><i class="fas fa-shopping-bag fa-fw"></i> &nbsp; Información</button>
		...
		<br></br>
		<br></br><?php foreach( $propiedades as $propiedad ): ?>
			<div class="card shadow-1-strong">
				
	            <img class="card-img-top" src="./assets/platillos/divinoniño.png" alt="proveedores">
	            <div class="card-body text-center">
