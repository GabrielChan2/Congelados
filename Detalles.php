	        ...
	        <div class="row">
	            <div class="col-12 col-lg-5">
	                ...
	                <figure class="full-box">
	                    <img class="img-fluid" src="./assets/platillos/salchicha.jpg" alt="platillo_">
	                </figure>
	            ...
	            <div class="col-12 col-lg-7">
	                ...
	                <h4 class="font-weight-bold poppins-regular tittle-details">Salchicha Kir</h4>

	                <p class="text-justify lead" style="padding: 40px 0;">
	                    <span class="text-info lead font-weight-bold">Descripción:</span><br>
	                   Salchicha de pavo de la marca Kir
	                </p>

	                <p class="lead font-weight-bold">Precio: $25.00 </p>
	                ...
	                <form action="" style="padding-top: 70px;">
	                    <div class="container-fluid">
	                        <div class="row">
								...
								<a href="Carrito.php" >Agregar a Carrito<span class="full-box" ></span></a>
	                            </div>
	                        </div>
	                    </div>
	                </form>
